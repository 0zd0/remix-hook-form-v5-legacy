...
describe('validateFormData', () => {
    it('should return an error when parsing date object without coerce', async () => {
        ...
        const returnData = await validateFormData(formData, zodResolver(object({ date: date() })))
...
describe('getValidatedFormData', () => {
    it('gets valid form data from formData', async () => {
        ...
        const validatedFormData = await getValidatedFormData(data, zodResolver(schema))
    ...
    it('gets valid form data from a GET request', async () => {
        ...
        const formData = await getValidatedFormData(request as any, zodResolver(schema))
        expect(formData).toStrictEqual({
            data: {
                user: {
                    name: 'john',
    ...
    it('gets valid form data from a POST request when it is js', async () => {
        ...
        const validatedFormData = await getValidatedFormData(request as any, zodResolver(schema))
        expect(validatedFormData).toStrictEqual({
            data: formData,
            receivedValues: formData,
            errors: undefined,
    ...
    it('gets valid form data from a POST request when it is no js', async () => {
        ...
        const returnData = await getValidatedFormData(request as any, zodResolver(schema))
